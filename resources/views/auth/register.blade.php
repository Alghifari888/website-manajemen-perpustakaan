...
<head>
    ...
    <title>Daftar Akun - Sistem Manajemen Perpustakaan Digital</title>
...
<body class="h-full">
    <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-6 bg-white rounded-xl register-card p-10">
            <div class="text-center">
                ...
                <p class="mt-2 text-sm text-gray-600">
                    Daftarkan diri Anda untuk mengakses perpustakaan digital
                </p>
            </div>
            ...
            <form class="mt-6 space-y-4" method="POST" action="{{ route('register') }}">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button type="button" class="password-toggle absolute right-3 top-3 text-gray-400 hover:text-gray-500"

                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('admin.members.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="nis_nim" class="block mt-1 w-full" type="text" name="nis_nim" :value="old('nis_nim')" />
                        ...
                        <div class="mt-4">
                            ...
                            <input id="profile_photo" name="profile_photo" type="file" class="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400">
